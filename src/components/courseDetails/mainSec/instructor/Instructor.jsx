...
import instructorImg from "../../../../assets/photos/images/instructor.PNG"
    ...
    return (
        <div id="instructor">
            ...
            <div id="instructor-info">
                <img src={instructorImg} alt="instructor-pic" />
                <div>
                    <ul>
                        <ListItem
                            icon={
            ...
            <p>FullStack Web developer, Freelancer, Instructor, CEO & Founder of HamdaouiAcademy platform.</p>
        </div>
    );
};
